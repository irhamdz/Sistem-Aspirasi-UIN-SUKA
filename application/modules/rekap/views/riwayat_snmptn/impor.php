<h2 style="margin-bottom:30px;">Impor Data Riwayat SBMPTN</h2>
...
<div id="information" class="bs-callout bs-callout-success">
	Format excel dapat didownload <a href="<?php echo base_url().'media/download/format_upload_data_riwayat_snmptn.xls'?>" class="btn btn-sm btn-success" style="color:#fff">disini</a>
	<br><br>
	Format upload data riwayat SBMPTN terdiri dari 4 kolom:
	<ol>
		<li>NPSN Sekolah</li>
		<li>Tahun</li>
		<li>Pendaftar</li>
