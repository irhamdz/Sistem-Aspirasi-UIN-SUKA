<h2 style="margin-bottom:30px;">Impor Data Nilai Peminat Mandiri</h2>
...
<div id="information" class="bs-callout bs-callout-success">
	Format excel dapat didownload <a href="<?php echo base_url().'media/download/format_upload_data_nilai_peminat_mandiri.xls'?>" class="btn btn-sm btn-success" style="color:#fff">disini</a>
	<br><br>
	Format upload data riwayat SBMPTN terdiri dari 2 kolom:
	<ol>
		<li>NPSN Sekolah</li>
		<li>Nilai</li>
	</ol>
