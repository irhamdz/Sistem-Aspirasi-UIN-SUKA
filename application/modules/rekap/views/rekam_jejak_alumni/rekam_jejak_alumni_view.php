<h2>Daftar Nilai Rekam Jejak Alumni</h2>
...
<a href="<?php echo site_url('snmptn/rekam_jejak_alumni/impor')?>" id="add" class="btn btn-inverse btn-small aksi" style="color:#fff" ><i class="icon-edit icon-white">&nbsp;</i> Impor Excel</a>
</div>
...
<table class="table table-bordered">
  ...
  <tbody>
      <?php if(!isset($rekam_jejak_alumni) or empty($rekam_jejak_alumni)):
      	echo '<td colspan="6" align="center">Belum ada data.</td>';
      else:
			$i = $offset;
		  foreach ($rekam_jejak_alumni as $d): 
			$i++;
			?>
			<tr>
