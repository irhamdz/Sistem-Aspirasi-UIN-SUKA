...
table.table_info td{border:none;}
						...
						<form method="post" action="">
							...
							?>
								...
								<table class="table_info">
									...
									<tr><td>Kepemilikan</td><td>:</td><td><?php echo $s->kepemilikan ?></td></tr>
								...
								<td>
									...
									Peringkat Siswa : <?php echo round(str_replace(',','.',$s->nilai_mapel),2) ?><br>
									SNMPTN Sekolah : <?php echo round(str_replace(',','.',$s->nilai_riwayat_snmptn),2) ?><br>
									SBMPTN Sekolah : <?php echo round(str_replace(',','.',$s->nilai_riwayat_sbmptn),2) ?><br>
	...
	<script>
		...
		$('#prodi').on('change', function() {
		  ...
		  window.location.href="<?php echo site_url('snmptn/yudisium/set_prodi/index')?>/"+prodi;
		});
