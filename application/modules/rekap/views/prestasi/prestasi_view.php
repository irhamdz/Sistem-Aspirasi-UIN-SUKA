...
<a href="<?php echo site_url('snmptn/prestasi/impor')?>" id="add" class="btn btn-inverse btn-small aksi" style="color:#fff" ><i class="icon-edit icon-white">&nbsp;</i> Impor Excel</a>
</div>
...
<table class="table table-bordered">
  <thead>
    <tr>
      ...
      <th width="10%">Id Prestasi</th>
      <th width="20%">Jenis Prestasi</th>
      <th width="15%">Jenjang Prestasi</th>
      <th width="35%">File Sertifikat</th>
    </tr>
  </thead>
  <tbody>
      <?php if(!isset($prestasi) or empty($prestasi)):
		  ...
		  foreach ($prestasi as $d): 
			...
			<tr>
				...
				<td><?php echo $d->id_prestasi; ?></td>
				<td><?php echo $d->jenis_prestasi; ?></td>
				<td><?php echo $d->jenjang_prestasi; ?></td>
				<td><?php echo $d->file_sertifikat; ?></td>
			</tr>
		  <?php endforeach; ?>
      <?php endif; ?>
  </tbody>
