<h2 style="margin-bottom:30px;">Impor Data Kelas</h2>
...
<div id="information" class="bs-callout bs-callout-success">
	Format excel dapat didownload <a href="<?php echo base_url().'media/download/format_upload_data_nilai_akademik.xls'?>" class="btn btn-sm btn-success" style="color:#fff">disini</a>
	<br><br>
	Format upload data siswa terdiri dari 6 kolom:
	<ol>
      <li>Id Kelas</li>
      <li>Tahun Diselenggarakan</li>
      <li>Kode Mata Tingkat</li>
      <li>Nama Kelas</li>
      <li>Kode Jenis Kelas</li>
      <li>Id Jurusan</li>
	</ol>
</div>
<script>
