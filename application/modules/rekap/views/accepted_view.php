			...
			<div id="content-space">
				...
				<br>			
						<div style="font-weight:bold; text-align:right; margin:10px;">
							<a href="<?php echo site_url('snmptn/yudisium/sk_yudisium/'); ?>"class="btn-uin btn btn-inverse" target="_blank">Cetak SK Yudisium</a>
							<a href="<?php echo site_url('snmptn/yudisium/sk_rektor/'); ?>" class="btn-uin btn btn-inverse" style="color:#fff; font-size:14px" target="_blank">Cetak SK Rektor</a>
						</div>
	...
	<script>
		...
		$('#prodi').on('change', function() {
		  ...
		  window.location.href="<?php echo site_url('snmptn/yudisium/set_prodi/accepted')?>/"+prodi;
		});
	</script>
