...
<div  class="article-content">						
	...
	<a href="<?php echo site_url('page/kolom/detail/'.$d->id_kolom.'/'.url_title(strtolower($d->judul))) ?>"><?php echo $d->judul ?></a>
	</div>
	...
	<div class="social-sharing">
		...
		<div class="social-button facebook">
			<div class="fb-share-button" data-href="<?php echo site_url('page/kolom/detail/'.$d->id_kolom.'/'.url_title(strtolower($d->judul))) ?>" data-type="button_count"></div>
		</div>
	...
	<?php 
		$isi=preg_replace('/<p align="center">(&nbsp;|[\s\p{Z}\p{C}\x85\xA0\x{0085}\x{00A0}\x{FFFD}]+)*<\/p>/iu',"",htmlspecialchars_decode($d->isi_kolom));
	...
	<div class="fb-like" data-href="<?php echo site_url('page/kolom/detail/'.$d->id_kolom.'/'.url_title(strtolower($d->judul))) ?>" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
	<div class="related-article left">
		...
		foreach($rec as $r){?>
			<li>
			<a href="<?php echo site_url('page/kolom/detail/'.$r->id_kolom.'/'.url_title(strtolower($r->judul))) ?>">
	...
	<div class="related-article right">
		...
		<?php
		foreach($pop as $r){?>
			<li><a href="<?php echo site_url('page/kolom/detail/'.$r->id_kolom.'/'.url_title(strtolower($r->judul))) ?>">
			<span class="tgl-post"><?php echo nama_hari($r->tgl_posting).', '.tanggal_indonesia($r->tgl_posting).' '.$r->jam_posting ?> WIB</span>
			<?php echo $r->judul ?></a></li>
		<?php } ?>
		</ul>
