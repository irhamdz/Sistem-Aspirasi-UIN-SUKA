...
<div class="login-form">
	<form method="post" action="<?php echo site_url('admin/validate')?>">		
		<div class="form-group">
			<input type="text" name="username" id="username" class="form-control" name="logu1" placeholder="Username">
		</div>
		<div class="form-group">
...
<div class="login-links">
	<div class="login-link">
		<a class="link-icon matakuliah" href="<?php echo site_url('page/dokumen/jadwal'); ?>" title="Daftar Sebagai Masyarakat">
		Daftar
		</a>
	</div>
	<div class="login-link">
		<a class="link-icon monitoring-surat" href="<?php echo site_url('page/dosen'); ?>" title="Cek Aspirasi">
		Cek Aspirasi
		</a>
	</div>
