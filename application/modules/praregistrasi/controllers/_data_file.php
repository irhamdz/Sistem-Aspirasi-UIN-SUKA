    ...
    function index(){
        ...
        */
        ...
        if($id_step_tujuan){
            ...
            $AKSI_1=$this->lib_reg_fungsi->dokumen_upload($NO_TEST,'DOC_PENGHASILAN_IBU',$DOC_PENGHASILAN_IBU_HIDDEN);
            if(ereg("<li>",$AKSI_1)){
                $ERR_AKSI_1=$AKSI_1;               
                //$err=1;
            }else{
            ...
            if(empty($ERR_AKSI_1)){
                ...
                $this->lib_reg_fungsi->post_data_global($ARR_DATA_1);
            }
            ...
            $AKSI_2=$this->lib_reg_fungsi->dokumen_upload($NO_TEST,'DOC_PENGHASILAN_BPK',$DOC_PENGHASILAN_BPK_HIDDEN);
            if(ereg("<li>",$AKSI_2)){
                $ERR_AKSI_2=$AKSI_2;
                //$err=1;
            }else{
            ...
            if(empty($ERR_AKSI_2)){
                ...
                $this->lib_reg_fungsi->post_data_global($ARR_DATA_2);
            }
            ...
            $AKSI_3=$this->lib_reg_fungsi->dokumen_upload($NO_TEST,'DOC_PENGHASILAN_WALI',$DOC_PENGHASILAN_WALI_HIDDEN);
            if(ereg("<li>",$AKSI_3)){
                $ERR_AKSI_3=$AKSI_3;
            ...
            if(empty($ERR_AKSI_3)){
                ...
                $this->lib_reg_fungsi->post_data_global($ARR_DATA_3);
            }
            ...
            $AKSI_4=$this->lib_reg_fungsi->dokumen_upload($NO_TEST,'DOC_PBB',$DOC_PBB_HIDDEN);
            if(ereg("<li>",$AKSI_4)){
                $ERR_AKSI_4=$AKSI_4;
            ...
            if(empty($ERR_AKSI_4)){
                ...
                $this->lib_reg_fungsi->post_data_global($ARR_DATA_4);
            }
            ...
            $AKSI_5=$this->lib_reg_fungsi->dokumen_upload($NO_TEST,'DOC_REK_LISTRIK',$DOC_REK_LISTRIK_HIDDEN);
            if(ereg("<li>",$AKSI_5)){
                $ERR_AKSI_5=$AKSI_5;
            ...
            if(empty($ERR_AKSI_5)){
                ...
                $this->lib_reg_fungsi->post_data_global($ARR_DATA_5);
            }
            ...
            $AKSI_6=$this->lib_reg_fungsi->dokumen_upload($NO_TEST,'DOC_KK',$DOC_KK_HIDDEN);
            if(ereg("<li>",$AKSI_6)){
                $ERR_AKSI_6=$AKSI_6;
            ...
            if(empty($ERR_AKSI_6)){
                ...
                $this->lib_reg_fungsi->post_data_global($ARR_DATA_6);
            }
            ...
            $AKSI_7=$this->lib_reg_fungsi->dokumen_upload($NO_TEST,'DOC_KARTU_MISKIN',$DOC_KARTU_MISKIN_HIDDEN);
            if(ereg("<li>",$AKSI_7)){
                $ERR_AKSI_7=$AKSI_7;
            ...
            if(empty($ERR_AKSI_7)){
                ...
                $this->lib_reg_fungsi->post_data_global($ARR_DATA_7);
            }
