...
class Rekap extends CI_Controller {
	...
	function peminat(){
		$peminat1=$this->webserv->spanptkin('rekap/rekap_peminat',array('PTN'=>1));
		$peminat2=$this->webserv->spanptkin('rekap/rekap_peminat',array('PTN'=>2));
		$arr_peminat1=array();
		...
		$data['content']='spanptkin/rekap/peminat';
	...
	function jenis_kelamin(){	
		...
		$data['jenis_kelamin1']=$this->webserv->spanptkin('rekap/rekap_jenis_kelamin',array('PTN'=>1));
		$data['jenis_kelamin2']=$this->webserv->spanptkin('rekap/rekap_jenis_kelamin',array('PTN'=>2));
		$data['jenis_kelamin']=$this->webserv->spanptkin('rekap/rekap_jenis_kelamin');
		$data['content']='spanptkin/rekap/jenis_kelamin';
		$this->load->view('admin/header',$data);
		$this->load->view('admin/content');
	}
	function provinsi($ptn=1){
		$data['prov1']=$this->webserv->spanptkin('rekap/rekap_provinsi',array('PTN'=>$ptn));
		$data['ptn']=$ptn;
		$data['content']='spanptkin/rekap/provinsi';
		$this->load->view('admin/header',$data);
		$this->load->view('admin/content');
	}
	function kabupaten($ptn=1){
		$data['kab1']=$this->webserv->spanptkin('rekap/rekap_kabupaten',array('PTN'=>$ptn));
		//$data['kab2']=$this->lib_yudisium->api_yudisium('spanptkin/yudisium/rekap_kabupaten',array('PTN'=>2));
		$data['ptn']=$ptn;
		$data['content']='spanptkin/rekap/kabupaten';
		$this->load->view('admin/header',$data);
		$this->load->view('admin/content');
	} 
	...
	function nilai(){		
		...
		$data['nilai']=$this->webserv->spanptkin('rekap/rekap_nilai');
		$data['content']='spanptkin/rekap/nilai';
		$this->load->view('admin/header',$data);
		$this->load->view('admin/content');
	} 
	...
	function diterima(){
		...
		$data['diterima']=$this->webserv->spanptkin('rekap/rekap_diterima');
		$data['content']='spanptkin/rekap/diterima';
		$this->load->view('admin/header',$data);
		$this->load->view('admin/content');
	} 
