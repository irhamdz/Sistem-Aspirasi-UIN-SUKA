					...
					<table class="table table-bordered">
						...
						?>
							<td>
								...
								<input type="text" class="numeric bas form-control"  name="nilai[<?php echo $jenjang; ?>][<?php echo $jurusan; ?>][<?php echo $b->kode_mata_pelajaran; ?>]" value="<?php echo $b->bobot; ?>" maxlength="5"  style="width:95px;">
...
$('#prodi').on('change', function() {
  ...
  window.location.href="<?php echo site_url('spanptkin/penilaian/set_prodi/nilai_akademik')?>/"+prodi;
});
