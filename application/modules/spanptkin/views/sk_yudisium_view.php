...
tbody {
	display:table-row-group;
					...
					<p style="font-weight:bold;">
						Lampiran:  <br/>
						Keputusan Dewan Yudisium Penerimaan Mahasiswa Baru UIN Sunan Kalijaga Yogyakarta<br/>
						Nomor: <?php echo $config->sk_yudisium?><br/>
						Tentang Penerimaan Calon Mahasiswa Baru Jalur SPAN-PTKIN Tahun Akademik <?php echo $config->ta?><br/>
