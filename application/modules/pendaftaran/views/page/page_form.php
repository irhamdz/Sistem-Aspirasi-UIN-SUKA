<h2 style="margin-bottom:30px;">Halaman Statis</h2>
...
<div id="">
	...
	<tbody><tr>
	  ...
	  <tr>
		<td colspan="2">
			<span>Isi</span>
			<textarea name="isi" id="text1" ><?php if(isset($d->ISI_HALAMAN)) echo $d->ISI_HALAMAN?></textarea>
	  ...
	  <tr>
		...
		<td>
			...
			<a href="<?php echo site_url('admin/page')?>" class="btn btn-inverse btn-uin btn-small">Batal</button>
		</td>
	  </tr>
