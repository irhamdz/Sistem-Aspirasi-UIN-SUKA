...
<script type="text/javascript">
	$(document).ready(function () {
		...
		var source =
		{
			...
			{ name: 'tgl_upload', type: 'string' },
			{ name: 'action', type: 'string' }
		],
		cache: false,
		url: "<?php echo site_url('admin/dokumen/dokumen_json')?>",
		filter: function()
		{
		...
		{	
			...
			columns: [
				...
				{ text: 'Tanggal', datafield: 'tgl_upload', width: 135 },
...
<div style="text-align:right; margin-bottom:5px;">		
	 <a  href="<?php echo site_url('admin/dokumen/add')?>" id='jqxButton'>Tambah</a>
</div>	 
<div id="jqxgrid"></div>
</div>