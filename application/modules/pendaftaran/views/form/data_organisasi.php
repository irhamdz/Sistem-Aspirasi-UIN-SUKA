...
var id=$('#nomor').attr('value');
	function simpan_org()
	{
					...
					$.ajax(
					{
						url 	: "<?php echo base_url('pendaftaran/form_control/insert_organisasi'); ?>",
						type	: "POST",            
						data: $("#data_organisasi").serialize(),
						success: function(x)
						{
							
							$('#slide-form').load("<?php echo base_url('pendaftaran/form_control/data_organisasi/"+id+"'); ?>");
	...
	function hapus_org(org)
	{
			$.ajax(
					{
						url 	: "<?php echo base_url('pendaftaran/form_control/hapus_organisasi'); ?>",
						type	: "POST",            
						data    : "id="+org,
						success: function(z)
						{
