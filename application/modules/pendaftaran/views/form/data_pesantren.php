...
function simpan_pesantren()
{
	...
	{
		$.ajax({
			url : "<?php echo base_url('pendaftaran/daftar_mhs_c/data_pesantren2') ?>",
			type: "POST",
...
//http://service.uin-suka.ac.id/servsiasuper/index.php/sia_public/sia_master/data_search
	...
	if(inputString.length == 0) {
		...
		type: "POST",
		cache:false,
		url: "<?php echo base_url('pendaftaran/form_control/cari_pesantren') ?>",
...
function hapus_pes(idr)
{
	...
	$.ajax({
		url: "<?php echo base_url('pendaftaran/form_control/hapus_riwayat') ?>",
		type: "POST",
