...
var id=$('#nomor').attr('value');
	function simpan_nilai_riwayat()
	{
		...
		$('#ipk').val(ipk_res);
					...
					$.ajax(
					{
						url 	: "<?php echo base_url('pendaftaran/form_control/insert_riwayat_nilai'); ?>",
						type	: "POST",            
						data: $("#data_riwayat_nilai_pendidikan_formal").serialize(),
						success: function(x)
						{
							
							$('#slide-form').load("<?php echo base_url('pendaftaran/form_control/data_riwayat_nilai_pendidikan_formal/"+id+"'); ?>");
	...
	function hapus_nilai_riwayat(ri)
	{
			$.ajax(
					{
						url 	: "<?php echo base_url('pendaftaran/form_control/hapus_riwayat_nilai'); ?>",
						type	: "POST",            
						data    : "id="+ri,
						success: function(z)
						{
