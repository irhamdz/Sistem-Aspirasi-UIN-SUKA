...
class Form_control extends CI_Controller
{
	...
	function lihat_kartu_ujian()
	{
		...
		$this->load->view('form/kartu_ujian',$data);
...
*/
			...
			if(!is_null($kuota))
			{
				...
				if($jml > 0)
				{
						...
						if($hasil_jadwal)
						{
							...
							echo $pesan;
							echo $this->load->view('v_table/view_table_jadwal_ujian',$hasil_jadwal);
						}
						}
				}
				else
	...
	function data_pesantren($id)
	{
		...
		$this->load->view("form/data_pesantren",$data);
	}
	...
	function data_bapak($id)
	{
		...
		$data['data_agama'] = $this->webserv->admisi('data_form/agama',array());
		$data['data_pendidikan'] = $this->webserv->admisi('data_form/jenjang',array());
		$this->load->view("form/data_bapak",$data);
	...
	function data_kesehatan($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_kesehatan",$data);
	}
	...
	function data_sertifikasi($id)
	{
		...
		$this->load->view("form/data_sertifikasi",$data);
	}
	...
	function data_prestasi($id)
	{
		...
		$this->load->view("form/data_prestasi",$data);
	}
	...
	function data_minat_dan_ketrampilan($id)
	{
		...
		$this->load->view("form/data_minat_dan_ketrampilan",$data);
	}
	function data_wali($id)
	{
		...
		$data['data_agama'] = $this->webserv->admisi('data_form/agama',array());
		$data['data_pendidikan'] = $this->webserv->admisi('data_form/jenjang',array());
		$this->load->view("form/data_wali",$data);
	}
	function data_kegiatan($id)
	{
		...
		$this->load->view("form/data_kegiatan",$data);
	}
	function data_rumah_tinggal_keluarga($id)
	{
		...
		$this->load->view("form/data_rumah_tinggal_keluarga",$data);
	}
	function data_organisasi($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_organisasi",$data);
	}
	function data_riwayat_nilai_pendidikan_formal($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$data['data_pendidikan'] = $this->webserv->admisi('data_form/jenjang',array());
		$this->load->view("form/data_riwayat_nilai_pendidikan_formal",$data);
	}
	function data_kontak_darurat($id)
	{
		...
		$data['data_negara'] = $this->webserv->admisi('data_form/negara',array());
		$data['data_provinsi'] = $this->webserv->admisi('data_form/provinsi',array());
		$this->load->view("form/data_kontak_darurat",$data);
	}
	function data_rencana_hidup($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_rencana_hidup",$data);
	}
	function riwayat_pendidikan_s2($id)
	{
		...
		$this->load->view("form/riwayat_pendidikan_s2",$data);
	}
	...
	function data_penelitian($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_penelitian",$data);
	}
	...
	function form_jadwal_ujian($id,$jal)
	{
		...
		$data['nomor_pendaftar']=$id;
		$data['kode_jalur']=$jal;
		$this->load->view("form/form_jadwal_ujian",$data);
	}
	...
	function data_karya_tulis($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_karya_tulis",$data);
	}
	...
	function hanya_cetak($id)
	{
		...
		$data['tawar']=$this->webserv->admisi('data_form/jalur_tawar',$nomor_pendaftar);
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/hanya_cetak",$data);
	}
	...
	function data_verifikasi($id)
	{
		...
		$data['tawar']=$this->webserv->admisi('data_form/jalur_tawar',$nomor_pendaftar);
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_verifikasi",$data);
	}
...
/* S1 */	case '1':
						...
						$data['penawaran_jalur']=$this->webserv->admisi('data_form/detail_penawaran_jalur',$kode_jalur);
...
/* S3 */	case '3':
	...
	function data_piljur($id,$jal)
	{
		...
		$kode_penawaran=$this->webserv->admisi('data_form/detail_penawaran_jalur',$kode_jalur);
		...
		$this->load->view('form/data_kelas_piljur',$data);
	}
	...
	function data_disertasi($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_disertasi",$data);
	}
	...
	function data_proposal_tesis($id)
	{
		...
		$data['nomor_pendaftar']=$id;
		$this->load->view("form/data_proposal_tesis",$data);
	}
	...
	function data_riwayat_pendidikan_sebelumnya($id,$jalur)
	{
		...
		$this->load->view("form/data_riwayat_pendidikan_sebelumnya",$data);
	}
}