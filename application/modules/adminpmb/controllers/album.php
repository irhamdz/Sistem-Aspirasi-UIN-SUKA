...
class Album extends CI_Controller
{
	...
	function cetak_album_ujian($pen,$ru,$jd) {
		...
		$hasil_no=$this->webserv->admisi('cetak/cari_nomor_peserta',$kirim);
	...
	//	$pdf->SetFont('helvetica', '', 10);	
		...
		$html=$this->load->view('album_view',$cetak_data,TRUE);
