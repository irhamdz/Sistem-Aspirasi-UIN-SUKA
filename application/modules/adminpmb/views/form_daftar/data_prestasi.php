...
function hapus_pres(id_hapus)
{
			$.ajax(
					{
						url 	: "<?php echo base_url('adminpmb/form_control/hapus_prestasi'); ?>",
						type	: "POST",            
						data: "id="+id_hapus,
						success: function(i)
						{
							
							$('#slide-form').load("<?php echo base_url('adminpmb/form_control/data_prestasi/"+id+"'); ?>");
...
function simpan_prestasi()
{
		...
		$.ajax(
					{
						url 	: "<?php echo base_url('adminpmb/form_control/insert_prestasi'); ?>",
						type	: "POST",            
