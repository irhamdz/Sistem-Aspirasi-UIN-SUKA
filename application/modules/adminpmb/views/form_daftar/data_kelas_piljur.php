<script type="text/javascript">
	...
	function cari_kuliah(idkelas)
	{
		...
		var tahun=$('#tahun').attr('value');
				$.ajax({
				url: "<?php echo base_url('adminpmb/form_control/lihat_kuliah') ?>",
				type: "POST",
			...
			url : "<?php echo base_url('adminpmb/form_control/req_prodi') ?>",
			type : "POST",
	...
	function pilih_lokasi(jadwal)
	{
		...
		if(jadwal.value != '')
		{
				...
				$.ajax(
					{
						url 	: "<?php echo base_url('adminpmb/form_control/update_pilih_jadwal'); ?>",
						type	: "POST",            
...
if(kelas==null)
{
	kelas=kelas_lagi;
					...
					$.ajax(
					{
						url 	: "<?php echo base_url('adminpmb/form_control/insert_piljur'); ?>",
						type	: "POST",            
...
function delete_prodi_3()
{
	var nomor=$('#nomor').val();
	$.ajax({
		url: "<?php echo base_url('adminpmb/form_control/delete_pil_prod_post') ?>",
		type: "POST",
...
{
	$.ajax({
		url: "<?php echo base_url('adminpmb/daftar_mhs_c/cari_fakultas') ?>",
		type: "POST",
