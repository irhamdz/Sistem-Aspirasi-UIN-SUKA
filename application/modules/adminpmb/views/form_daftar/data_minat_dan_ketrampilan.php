...
var id=$('#nomor').attr('value');
	function simpan_ketrampilan()
	{
					...
					$.ajax(
					{
						url 	: "<?php echo base_url('adminpmb/form_control/insert_minat'); ?>",
						type	: "POST",            
						data: $("#data_minat_ketrampilan").serialize(),
						success: function(x)
						{
							
							$('#slide-form').load("<?php echo base_url('adminpmb/form_control/data_minat_dan_ketrampilan/"+id+"'); ?>");
	...
	function hapus_ketrampilan(del)
	{
		...
		$.ajax(
					{
						url 	: "<?php echo base_url('adminpmb/form_control/hapus_minat'); ?>",
						type	: "POST",            
						data    : "id="+del,
						success: function(z)
						{
