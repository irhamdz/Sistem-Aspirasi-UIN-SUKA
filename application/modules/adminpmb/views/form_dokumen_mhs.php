...
<div>
<h3 style="margin-bottom:10px;">REKAP DOKUMEN MAHASISWA</h3>
	<table class="table table-hover">
		...
		<tr id="ktg_jalur">
			...
			<td>
				<select name='kode_jalur' class="form-control input-md" id="pena" onchange="kode_penawaran=this.value;cari_gelombang(this.value)" style="width:300px;">
...
function doc_jalur () {
	...
	$.ajax({
		url: "<?php echo base_url('adminpmb/input_data_c/cari_dokumen'); ?>",
		type: "POST",
