...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		if(isset($title)){
			...
			echo"<title>Sistem Penerimaan Mahasiswa Baru</title>";
			echo" <meta content='Sistem Penerimaan Mahasiswa Baru' name='description'/>";
		}
		?>
				...
				<div class="center">
					...
					<div class="app_header_right">
						<div style="text-align:right; margin-top:-15px;">
							<div>
								<div class="app_system_id">Sistem Penerimaan Mahasiswa Baru</div>
							</div>
