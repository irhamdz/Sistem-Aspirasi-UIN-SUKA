...
<script type="text/javascript">
	$(document).ready(function () {
		...
		var source =
		{
			...
			datafields: [
			{ name: 'no', type: 'string'},
			{ name: 'nama_unit', type: 'string'},
			{ name: 'content', type: 'string' },
			{ name: 'action', type: 'string' }
		],
		cache: false,
		url: "<?php echo site_url('admin/unit/unit_json')?>",
		filter: function()
		{
		...
		{	
			...
			columns: [
				...
				{ text: 'Nama Unit', datafield: 'nama_unit', width: 300 },
				{ text: 'Konten', datafield: 'content', width: 335 },
...
<div style="text-align:right; margin-bottom:5px;">		
	 <a  href="<?php echo site_url('admin/unit/add')?>" id='jqxButton'>Tambah</a>
</div>	 
<div id="jqxgrid"></div>
</div>