<h2 style="margin-bottom:30px;">Kolom</h2>
...
<div id="">
	...
	<tbody><tr>
	  ...
	  <tr>
		<td colspan="2">
			<span> Isi</span>
			<textarea name="isi" id="text1" ><?php if(isset($d->isi_kolom)) echo $d->isi_kolom?></textarea>
	  ...
	  <tr>
		...
		<td>
			...
			<a href="<?php echo site_url('admin/kolom')?>" class="btn btn-inverse btn-uin btn-small">Batal</button>
		</td>
	  </tr>
