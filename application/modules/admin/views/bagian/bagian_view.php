...
<script type="text/javascript">
	$(document).ready(function () {
		...
		cache: false,
		url: "<?php echo site_url('admin/bagian/bagian_json')?>",
		filter: function()
		{
		...
		{	
			...
			columns: [
				...
				{ text: 'Nama bagian', datafield: 'nama_bagian', width: 300 },
...
<div style="text-align:right; margin-bottom:5px;">		
	 <a  href="<?php echo site_url('admin/bagian/add')?>" id='jqxButton'>Tambah</a>
</div>	 
<div id="jqxgrid"></div>
</div>