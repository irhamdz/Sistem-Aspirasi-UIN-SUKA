...
class agenda extends CI_Controller {
	...
	//	print_r($insert_data);die();
			if($kd_ruang!=null){
				...
				$result=$this->webserv->admisi('agenda/add_agenda',$data);
	...
	function edit($id=0){
		if($_POST==NULL) {
			...
			array('api_kode'=>1001, 'api_subkode'=>2));
			$data['d'] =$this->webserv->admisi('agenda/agenda_detil',array('ID'=>$id));
			$data['ruang']=$ruang;
			$data['content']="admin/agenda/agenda_form";
			$this->load->view('admin/header',$data);
			$this->load->view('admin/content');
			$this->load->view('page/footer');
				...
				$d = $this->webserv->admisi('agenda/agenda_detil',array('ID'=>$id));
			...
			if($kd_ruang!=null){
				...
				//print_r($data);die();
				$result=$this->webserv->admisi('agenda/edit_agenda',$data);
				$this->session->set_flashdata('message', 'Data berhasil disimpan.');
				//print_r($result);die();
				redirect('admin/agenda/index');
	...
	function delete($id=""){	
		...
		print_r($d);
		$result = $this->webserv->admisi('agenda/delete_agenda',$data);
