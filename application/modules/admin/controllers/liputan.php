...
public $data 	= 	array();
	...
	public function add() {
		if($_POST==NULL) {
			...
			$this->load->view('page/footer');
				...
				$d=$this->webserv->admisi('liputan/add_liputan',$data);
	...
	public function edit($id=0) {
		if($_POST==NULL) {
			...
			$data['d'] = $this->webserv->admisi('liputan/liputan_detil',array('ID'=>$id));
			$data['content']="admin/liputan/liputan_form";
			$this->load->view('admin/header',$data);
			$this->load->view('admin/content');
			$this->load->view('page/footer');
			...
			$result = $this->webserv->admisi('liputan/edit_liputan',$data);
			$this->session->set_flashdata('message', 'Data berhasil disimpan.');
			redirect('admin/liputan/index');
		}			
	}
	...
	function delete($id=""){
		$data['d'] = $this->webserv->admisi('liputan/liputan_detil',array('ID'=>$id));
		$data=array('ID'=>$id);
		$result = $this->webserv->admisi('liputan/delete_liputan',$data);
