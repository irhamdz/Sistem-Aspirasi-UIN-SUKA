...
<h3 style="margin-bottom:10px;">REKAP NILAI YUDISIUM</h3>
...
<form id="nilai-form" method="POST" enctype="multipart/form-data">
	...
	<table class="table table-hover">
		...
		<td></td>
			<td>
				<button class="btn btn-inverse btn-uin btn-small" type="button" onclick="ambil_rekap_nilai()"> CARI</button>
			</td>
		</tr>
		</form>
		</table>
...
function ambil_rekap_nilai()
{
	...
	$.ajax({
		url: "<?php echo base_url('yudisium/yudisium_c/rekap_nilai_yudisium') ?>",
		type: "POST",
		data: "kode_jalur="+kode_jalur+"&gelombang="+gelombang+"&tahun="+tahun+"&kode_penawaran="+kode_penawaran,
