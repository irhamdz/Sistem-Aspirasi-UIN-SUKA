<div  class="article-content">
	<?php foreach($kolom as $b){ ?>
						
		<div class="news-list">
			<div class="judul-artikel">
			<a href="<?php echo site_url('page/kolom/detail/'.$b->id_kolom.'/'.url_title(strtolower($b->judul))) ?>"><?php echo $b->judul ?></a>
			</div>
			...
			<?php
			$isi=preg_replace('/<p align="center">(&nbsp;|[\s\p{Z}\p{C}\x85\xA0\x{0085}\x{00A0}\x{FFFD}]+)*<\/p>/iu',"",htmlspecialchars_decode($b->isi_kolom));
			...
			<a class="btn-uin btn btn-inverse btn btn-small" style="float:right"  href="<?php echo site_url('page/kolom/detail/'.$b->id_kolom.'/'.url_title(strtolower($b->judul))) ?>"><i class="btn-uin"></i>Selengkapnya >></a> 
			<div style="clear:both"></div>
		</div>
	<?php } ?>
