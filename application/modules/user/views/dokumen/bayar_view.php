<div id="content-center">
		<div class="article-title">Panduan dan Tarif Pembayaran</div>
		<div class="clear10"></div>
		<?php if(!empty($panduan)):?>
		<?php foreach($panduan as $id=>$j):?>
			<?php if($id==0){?>
		...
		<?php foreach($tarif as $id=>$d):?>
			<?php if($id==0){?>
				...
				<a class="btn-uin btn btn-inverse btn btn-small" style="float:right; margin-left:5px"  href="<?php echo site_url('page/dokumen/sourcefile/'.$j->id_histori_dokumen.'/'.$j->nama_histori)?>"><i class="btn-uin"></i>Download File Sumber</a> 				 
				<?php endif ?>
				<a class="btn-uin btn btn-inverse btn btn-small" style="float:right"  href="<?php echo site_url('page/dokumen/docfile/'.$d->id_histori_dokumen.'/'.$j->nama_histori)?>"><i class="btn-uin"></i>Download PDF</a> 				 
				<div class="clear10"></div>
			<?php }else{ ?>
				<p>
