...
<div id="midnav">
			...
			<tbody>
				<tr>
					...
					switch($jalur){
						case 40 : echo "MAGISTER (S3) By Course"; break;
						case 50 : echo "MAGISTER (S3) By Course Ekonomi Islam"; break;
						case 80 : echo "Doktor (S3) By Research"; break;
					} ?></strong>
		...
		<?php } ?>
				...
				<tr>
					<td colspan="2"> Tanggal Ujian: <br><strong>3 – 4 November 2014</strong></td>
				</tr>
			</tbody>
		</table>
	</div>
  ...
  <br><br><i>Jadwal ujian:</i>
	...
	<table border="1" cellpadding="1" cellspacing="2" width="100%">
		<tbody>
			...
			<tr>
				<td></td>
				<td colspan="2"><strong>Senin, 03 November 2014</strong></td>
			...
			<tr>
				<td></td>
				<td colspan="3"><strong>Selasa, 04 November 2014</strong></td>
			</tr>
			<tr>
				<td></td>
				<td colspan=2>Presentasi Proposal</td>
