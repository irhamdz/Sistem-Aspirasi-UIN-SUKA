...
<table class="table table-bordered table-hover">
			...
			foreach($informasi_ruang_ujian as $value){
				...
				$kapasitas_terisi = $kapasitas_terisi + $value->TERISI;
					...
					switch($jalur){ 
								  ...
								  case 10: $jenis=1; $gel=10; break; // gel 1 s1 d3
								}
					
					$nomer_awal=$value->PMB_NO_UJIAN_AWAL;
					if (($nomer_awal>=0)&&($nomer_awal<10)) 
							$no_awal = "0000$value->PMB_NO_UJIAN_AWAL"; //00001 - 9
					elseif (($nomer_awal>=10)&&($nomer_awal<100)) 
							$no_awal = "000$value->PMB_NO_UJIAN_AWAL"; // 00010 - 99
					elseif (($nomer_awal>=100)&&($nomer_awal<1000))
							$no_awal = "00$value->PMB_NO_UJIAN_AWAL"; // 00100 - 999
					elseif (($nomer_awal>=1000)&&($nomer_awal<10000))
							$no_awal = "0$value->PMB_NO_UJIAN_AWAL"; // 00100 - 9999
					...
					elseif (($nomer_akhir>=100)&&($nomer_akhir<1000))
							$no_akhir = "00$value->PMB_NO_UJIAN_AKHIR"; // 00100 - 999	
					elseif (($nomer_akhir>=1000)&&($nomer_akhir<10000))
							$no_akhir = "0$value->PMB_NO_UJIAN_AKHIR"; // 00100 - 9999
			...
			?>
				<tr>
					...
					<td align='left'><?php echo $value->PMB_NAMA_GEDUNG; ?></td>
