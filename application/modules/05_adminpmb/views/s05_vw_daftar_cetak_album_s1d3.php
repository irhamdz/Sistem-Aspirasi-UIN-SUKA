<?php
$crumbs = array(array('Beranda'=>base_url()),array('Cetak Album Ujian D3/S1' => ''));
...
<div class="system-content-sia">
			...
			foreach($informasi_ruang_ujian as $value){
				...
				$jalur=$value->PMB_JALUR_UJIAN;
					switch($jalur){ 
								  case 10: $jenis=1; $gel=1; break; // gel 1 s2
								  case 11: $jenis=1; $gel=2; break; // gel 2 s2
								}
					...
					$cetak_cover="<a class='btn' href='/adminpmb/tools-cetak_cover_ujian/ruang-$value->PMB_ID_RUANG-$value->PMB_KAPASITAS_RUANG-$value->TERISI-$no_aw-$no_ak-$value->NAMA_RUANG-$PMB_NAMA_GEDUNG' title='Cetak Cover Album Ujian'><i class='icon-print'></i><a>";
					$cetak="<a class='btn' href='/adminpmb/tools-cetak_album_ujian_s1d3/ruang-$value->PMB_ID_RUANG-$value->PMB_KAPASITAS_RUANG-$value->TERISI-$no_aw-$no_ak-$value->NAMA_RUANG-$PMB_NAMA_GEDUNG' title='Cetak Album Ujian'><i class='icon-print'></i><a>";
					$cetak_form_verifikasi="<a class='btn' href='/adminpmb/tools-cetak_form_verifikasi_ujian_s1d3/ruang-$value->PMB_ID_RUANG-$value->PMB_KAPASITAS_RUANG-$value->TERISI-$no_aw-$no_ak-$value->NAMA_RUANG-$PMB_NAMA_GEDUNG' title='Cetak Form Verifikasi Ujian'><i class='icon-print'></i><a>";
					}
					...
					<tr>
					<th>$NO_GEDUNG</th>
					<td colspan=4>".$PMB_NAMA_GEDUNG."</td>
				</tr><tr>
					<th width='5%'>NO</th>
