<script type="text/javascript">
	...
	function prev_nilai(){
		...
		$.ajax({
			url: "<?php echo base_url() ?>adminpmb/tools-soal/upload_ljk",
			data: fd, 
			processData: false,
			contentType: false,
			type: 'POST',
...
<?php
$crumbs = array(array('Beranda'=>base_url()),array('Input Data LJK' => ''));
$this->s00_lib_output->output_crumbs($crumbs);
?>
<div class='bs-callout bs-callout-warning'><p>
	<ul>		
		<li>Upload file(xls) hasil SCAN LKJ dengan menekan tombol <b>Upload</b></li> 
	</ul>
</p></div>
