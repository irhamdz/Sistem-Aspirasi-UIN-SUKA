...
$crumbs = array(array('Beranda'=>base_url()),array('Data Calon Mahasiswa S1 D3' => ''));
...
<table class="table table-bordered table-hover">
			...
			<?php foreach($data_cmhs as $value){ ?>
				<tr>
					...
					<td align='center'><?php echo anchor('adminpmb/laporan-detail_calon_mahasiswa_s1d3/'.$value->PMB_PIN_PENDAFTAR.'', ''.$value->PMB_PIN_PENDAFTAR.'', 'class=link-table title=""'); ?></td>
