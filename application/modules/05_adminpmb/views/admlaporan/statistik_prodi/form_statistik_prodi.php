...
$("form#fup_bp").submit(function() {
    ...
    //console.log(nim);
    $.ajax({
        url: 'admlaporan-statistik_peminat_perprodi',
        type: 'POST',
        data: formData,
        //async: false,
        cache: false,
...
<h2>Statistik Peminat Per Prodi</h2>
<?php
// $crumbs = array(array('Beranda'=>base_url()),array('Statistik Peminat Per Prodi' => 'adminpmb/admlaporan-statistik_peminat_perprodi'));
...
<table class="table table-hover">
	<tbody>
		<tr>
			...
			<td><div class="col-xs-6"><select name='GELOMBANG' id='GELOMBANG' class="form-control input-sm" style="margin-bottom:0;">
		...
		<tr>
			...
			<td><div class="col-xs-6"><select name='TAHUN' id='TAHUN' class="form-control input-sm" style="margin-bottom:0;">
