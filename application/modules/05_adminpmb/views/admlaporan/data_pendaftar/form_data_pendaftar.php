...
<table class="table table-hover">
	<tbody>
		<tr>
			...
			<td><div class="col-xs-7"><select name='GELOMBANG' id='GELOMBANG' class="form-control input-sm" style="margin-bottom:0;">
		...
		<tr>
			<td><label for="WARGANEGARA" style="margin-top:5px;">Status</label></td>
			<td><div class="col-xs-7"><select name='WARGANEGARA' id='WARGANEGARA' class="form-control input-sm" style="margin-bottom:0;">
