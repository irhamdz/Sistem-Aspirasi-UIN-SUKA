		...
		<tbody>
			<tr>
				...
				<td><table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tbody>
							<tr>
								<td colspan="3"><span class="headerjudul">FORM VERIFIKASI PESERTA UJIAN TULIS JALUR REGULER D3/S1 2014</span><br>
							...
							<tr>
								...
								<td>:</td>
								<td><span class="headercontent"><?php echo $kondisi[6]; ?></span></td>
							</tr>
							<tr>
...
<div id="infohal"><i>Halaman <?php echo $n; ?> dari <?php echo $dari;?></i></div><br><br>	
	<table border="0" cellpadding="1" cellspacing="2" width="100%">
		<tbody><tr>
			...
			<td width="350"></td>
			<td align="center">Yogyakarta, 15-07-2014<br>Petugas Verifikasi</td></tr>
			<tr>
				<td></td>
				<td></td>
