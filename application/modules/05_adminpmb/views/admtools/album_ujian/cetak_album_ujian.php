...
<div id="coverprint">
    ...
    <td>&nbsp;</td>
		  ...
		  <tr><td align="center"><h3>TAHUN <?php echo $TAHUN ?></h3></td></tr>
		  ...
		  <tr>
			  <td align="center">
				<table class="tabelpesertaborder_cover" align="center" border="0" cellpadding="2" cellspacing="0" width="220px">
					<tbody>
						<tr>
							<td align="center"><h2>KODE RUANG : <?php echo strtoupper($NAMA_RUANG); ?></h2></td>
						</tr>
					</tbody>
				</table> &nbsp;
				  <br /><br />
			  ...
			  <tr align="left">
				...
				<td width="5px">:</td>
				<td><h3><?php echo $NAMA_GEDUNG; ?></h3></td>
			  </tr>
			  <tr  align="left">
				<td valign="top"><h3>RUANG </h3></td>
				<td valign="top">:</td>
				<td><h3><?php echo strtoupper($NAMA_RUANG); ?></h3></td>
			  </tr>
			  <tr  align="left">
...
<tbody>
  <tr>
	...
	<table width="100%">
      <tbody>
		<tr>
			<td colspan="3"><strong>ALBUM BUKTI HADIR PESERTA UJIAN TULIS <?php echo $TAHUN ?><br /></strong></td>
        </tr>
		<tr>
		...
		<tr>
			<td>RUANG</td>
			<td>:</td>
			<td><?php echo strtoupper($NAMA_RUANG); ?></td>
        </tr>
    </tbody>
	</table>
	</td>
...
<table class="tabelpesertaborder" border="0" cellpadding="2" cellspacing="0" width="300px">
      <tbody>
		<tr>
			<td style="height:60px !important;" width="40" border="0"><img src="<?php echo base_url('img_pendaftar/'.$jenis.'/'.$TAHUN.'/'.$GELOMBANG.'/'.$value->PMB_FOTO_PENDAFTAR.''); ?>" width="40" border="0"/></td>
			<td width="130px"><br /><br />
			  ...
			  <?php BREAK;
				CASE 20: CASE 21: CASE 22: CASE 40: CASE 50: CASE 80: ?>
				<tr>
                <td >NAMA PT</td>
                <td >:</td>
