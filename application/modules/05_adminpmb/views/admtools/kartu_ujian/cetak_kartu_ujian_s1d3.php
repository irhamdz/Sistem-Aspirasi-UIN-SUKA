			...
			<table border="0" width="100%">
				<tbody>
					...
					<tr>
						...
						*/ ?>
						<img src='<?php echo base_url().'img_pendaftar/'.$jenis.'/'.$cetak_kartu_ujian[0]->PMB_TAHUN_PENDAFTARAN.'/'.$cetak_kartu_ujian[0]->PMB_GELOMBANG_PENDAFTAR.'/'.$cetak_kartu_ujian[0]->PMB_FOTO_PENDAFTAR.''; ?>' width="95" />
