<?php
// print_r($master_prodi); 


// echo $cetak_kartu_ujian[0]->PMB_PILJUR_1;
			...
			<table border="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<img src='<?php echo base_url().'img_pendaftar/'.$jenis.'/'.$cetak_kartu_ujian[0]->PMB_TAHUN_PENDAFTARAN.'/'.$cetak_kartu_ujian[0]->PMB_JALUR_PENDAFTARAN.'/'.$cetak_kartu_ujian[0]->PMB_FOTO_PENDAFTAR.''; ?>' width="95" />
						*/ ?>
						<img src='<?php echo base_url().'img_pendaftar/'.$jenis.'/2015/'.$cetak_kartu_ujian[0]->PMB_JALUR_PENDAFTARAN.'/'.$cetak_kartu_ujian[0]->PMB_FOTO_PENDAFTAR.''; ?>' width="95" />
						</div></td>
					</tr>
					<tr>
...
<div id="midnav">
			...
			<tbody>
				<tr>
					...
					<strong>
					<?php $GELOMBANG=$cetak_kartu_ujian[0]->PMB_JALUR_PENDAFTARAN;
					switch($GELOMBANG){
