...
<table class="table table-nama" style="border: none; margin-bottom:2%; width: 100%;">
	<tbody>
		...
		<tr>
			...
			<td><div class="col-xs-7"><input type='text' onkeypress="return isNumberKey(event)" class="form-control input-sm" name='pmb1_nisn' maxlength="10" required value="<?php echo $pendaftar[0]->PMB_NISN_PENDAFTAR; ?>" /></div> *)</td>
		</tr>
		<?php } ?>
		<tr>
	...
	<tr>
		...
		<td class="reg-input">
			...
			<div class="col-xs-7">
				<input type="text"  class="form-control input-sm"  autocomplete="off" class="inputx" id="nama_kabupaten_lahir" value='<?php echo $NAMA_KAB_LAHIR; ?>'  style="width:200px" onkeyup="kabupaten_cari(this.value,'suggestions','KD_KAB_LAHIR','nama_kabupaten_lahir');return false;" onblur="hilangkan_ajax('suggestions')"></div> *)
			
			<span id="suggestionsLoading"></span><BR />
			<BR />
			<div class="col-xs-7">
		...
		<tr>
			...
			<td>
					...
					<div class="input-group date" id="tgl" data-date="" data-date-format="dd-mm-yyyy">
								<input class="form-control" type="text" value="<?php echo $pendaftar[0]->PMB_TGL_LAHIR_PENDAFTAR; ?>" name="pmb1_tgl_lahir">
		...
		<tr>
			...
			<td><div class="col-xs-7"><input type='text' onkeypress="return isNumberKey(event)"  name='pmb1_nohp'  class="form-control input-sm" required value="<?php echo $pendaftar[0]->PMB_TELP_PENDAFTAR; ?>" /></div> *) </td>
		</tr>
		
		<tr>
			<td width='200'>No. Telepon </td>
			
			<td><div class="col-xs-7"><input type='text'  name='TELEPON_RUMAH'  class="form-control input-sm" value="<?php echo $pendaftar[0]->TELEPON_RUMAH; ?>" /></div> 
			<div class="col-xs-12"><div class="reg-info">Apabila tidak punya ditulis <STRONG>TIDAK ADA</STRONG>.</div></div>
			</td>
		</tr>
		<tr>
			<td>Email</td>
	...
	<?php /*
		...
		<td class="reg-input">
			<div class="col-xs-7"><input onkeypress="return isNumberKey(event)" style="width:50px" name="RT_ASAL"  class="form-control input-sm" maxlength="5" type="text" value='<?php echo $pendaftar[0]->RT; ?>' class="inputx"></div>  *)
	...
	<tr>
		...
		<td class="reg-input">
			<div class="col-xs-7"><input onkeypress="return isNumberKey(event)" style="width:50px" name="RW_ASAL" class="form-control input-sm" maxlength="5" type="text" value='<?php echo $pendaftar[0]->RW; ?>' class="inputx"></div>   *)
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="reg-input" >
			<div class="col-xs-7"><input name="KODE_POS" onkeypress="return isNumberKey(event)"	 class="form-control input-sm" maxlength="5" value='<?php echo $KODE_POS; ?>' type="text" class="inputx"></div> *)
		</td>
	</tr>
	<tr>
			<td >Foto</td>
