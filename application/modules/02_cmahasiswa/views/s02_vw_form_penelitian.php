...
<table class="table table-nama" style="border: none; margin-bottom:2%; width: 100%;">
	<tbody>
		<tr>
			<td colspan='2'><br /><strong>Data Penelitian</strong><br /></td>
		</tr>
		<tr>
			<td width=150 >Judul</td>
			<td><div class="col-xs-7"><input type="text" class="form-control input-sm" name="judul_penelitian" /></div> *)</td>
		</tr>
		<tr>
			<td >Kedudukan / Status</td>
			<td><div class="col-xs-7"><input type="text" class="form-control input-sm" name="kedudukan" /></div> *)</td>
		</tr>
		<tr>
			<td >Tahun Penelitian</td>
			<td><div class="col-xs-7"><input type="text" class="form-control input-sm" name="tahun_penelitian" /></div> *)</td>
		</tr>
		<tr>
			<td >Sponsor</td>
			<td><div class="col-xs-7"><input type="text" class="form-control input-sm" name="sponsor" /></div> *)</td>
		</tr>
		<tr>
			
				<td align='left'><a href='data-pekerjaan' class="btn btn-small btn-inverse btn-uin-right"><< Sebelumnya</button></a></td>
			<td align='right'><input type='hidden' name='step_form' value='insert' /><input type="hidden" name="step" value="insert_penelitian"><?php echo form_submit('pmb1_penelitian_submit', 'Selanjutnya >>', 'class="btn-uin btn btn-inverse btn btn-small"'); ?></td>
		</tr>
	</tbody>
	</table>
	<?php echo form_close(); 
