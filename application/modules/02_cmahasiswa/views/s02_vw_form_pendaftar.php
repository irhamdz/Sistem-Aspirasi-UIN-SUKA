...
<table class="table table-nama" style="border: none; margin-bottom:2%; width: 100%;">
	<tbody>
		...
		<?php } ?>
		<tr>
		<td class="reg-label" width='200'>Gelar Depan Non Akademik</td>
	...
	<tr>
		...
		<td class="reg-input">
			...
			<div class="col-xs-5"><input type="text" autocomplete="off" class="form-control input-sm" class="inputx" id="nama_kabupaten_lahir" style="width:200px" onkeyup="kabupaten_cari(this.value,'suggestions','KD_KAB_LAHIR','nama_kabupaten_lahir');return false;" onblur="hilangkan_ajax('suggestions')"></div>&nbsp;&nbsp;&nbsp;*)
	...
	<tr>
		...
		<td>
					<div class="col-xs-6">
						<div class="input-group date" id="tgl" data-date="" data-date-format="dd-mm-yyyy">
								<input class="form-control" type="text" name="pmb1_tgl_lahir">
		...
		<td class="reg-input">
			<div class="col-xs-2"><input style="width:50px" name="RT_ASAL" maxlength="5" type="text" class="form-control input-sm" class="inputx"></div> *)
	...
	<tr>
		...
		<td class="reg-input">
			<div class="col-xs-2"><input style="width:50px" name="RW_ASAL" maxlength="5" type="text" class="form-control input-sm" class="inputx"></div>  *)
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<tr>
			...
			<td><div class="col-xs-7"><input type='text'  name='TELEPON_RUMAH'  class="form-control input-sm" /></div> 
		...
		*/ ?>
		<tr>
			...
			<td><div class="col-xs-5"><input type='file' name='userfile'  /></div>  *)</td>
		</tr>
		<?php /*
		<tr>
			<td colspan='3'>
