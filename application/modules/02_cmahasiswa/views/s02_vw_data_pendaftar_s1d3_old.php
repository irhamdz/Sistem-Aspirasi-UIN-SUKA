...
<table class="table table-nama" style="border: none; margin-bottom:2%; width: 100%;">
	<tbody>
		...
		<tr>
			<td>NISN</td>
			<td>:</td>
			<td><input type='text' name='pmb1_nisn' maxlength="10" class="required" value="<?php echo $pendaftar[0]->PMB_NISN_PENDAFTAR; ?>" /> *)</td>
		</tr>
		<tr>
			...
			?>
			<input type='text' name='pmb1_nama_lengkap' class="required" value="<?php echo $nama_pendaftar; ?>" /> *)</td>
		</tr>
		<tr>
			<td >Tempat Lahir</td>
			<td>:</td>
		...
		<tr>
			<td >Alamat</td>
			<td>:</td>
			<td><textarea style="width:400px;height:100px" name='pmb1_alamat' class="required"><?php echo $pendaftar[0]->PMB_ALAMAT_LENGKAP_PENDAFTAR; ?></textarea> *) <br />** Format Pengisian : Alamat Rumah / Nama Jalan, RT, RW, Kelurahan, Kecamatan, Kabupaten, Propinsi, Negara, Kodepos</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<select  name='pmb1_jenis_sekolah' id='jenis_sekolah' class="required">
					<option value=''>Pilih</option>
					<?php 
		...
		<tr>
			...
			<td><?php 
				...
				<select name='pmb1_jurusan_sekolah' id='jurusan_sekolah' class="required">
					<option value=''>Pilih</option>
				<?php
		...
		<tr>
			...
			<td>:</td>
			<td><textarea name='pmb1_alamat_sekolah' class="required"><?php echo $pendidikan_s1d3[0]->PMB_ALAMAT_SEKOLAH; ?></textarea>	*)</td>
		</tr>
		<tr>
			<td >Tahun Lulus</td>
			<td>:</td>
			<td><input type='text' name='pmb1_tahun_lulus' class="required" value='<?php echo $pendidikan_s1d3[0]->PMB_TAHUN_LULUS; ?>' />	*)</td>
		</tr>
		*/ ?>
		<tr>
