...
<table class="table table-nama" style="border: none; margin-bottom:2%; width: 100%;">
	...
	<tr>
		...
		<td><div class="col-xs-7"><select name='pmb2_pilihan_2' class="form-control input-sm">
			<?php echo $piljur[0]->PMB_PILJUR_2;
				foreach($master_prodi as $value){ 
	...
	<tr>
		...
		<td><div class="col-xs-7"><select name='pmb2_pilihan_3' class="form-control input-sm">
			<?php echo $piljur[0]->PMB_PILJUR_3;
				foreach($master_prodi as $value){ 
								if($value->PMB_ID_PRODI==$piljur[0]->PMB_PILJUR_3){
									echo "<option value=".$value->PMB_ID_PRODI." selected>".$value->PMB_NAMA_PRODI."</option>";
								}else{
									echo "<option value=".$value->PMB_ID_PRODI.">".$value->PMB_NAMA_PRODI."</option>";
								}
	...
	<tr>
			<td colspan='2'><input type='hidden' name='current_page' value='<?php echo $this->security->xss_clean($this->uri->segment(1)).'/'.$this->security->xss_clean($this->uri->segment(2)); ?>' /><input type="hidden" name="step" value="21">
