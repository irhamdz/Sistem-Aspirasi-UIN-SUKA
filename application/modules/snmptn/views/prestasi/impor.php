<h2 style="margin-bottom:30px;">Impor Data Prestasi</h2>
...
<div id="information" class="bs-callout bs-callout-success">
	...
	<br><br>
	Format upload data siswa terdiri dari 5 kolom:
	<ol>
      <li>No. Pendaftaran</li>
      <li>Id Prestasi</li>
      <li>Jenis Prestasi</li>
      <li>Jenjang Prestasi</li>
      <li>File Sertifikat</li>
	</ol>
</div>
<script>
	$(function(){
