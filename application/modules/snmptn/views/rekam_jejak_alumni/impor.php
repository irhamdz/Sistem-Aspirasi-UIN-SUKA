<h2 style="margin-bottom:30px;">Impor Data Rekam Jejak Alumni</h2>
...
<div id="information" class="bs-callout bs-callout-success">
	Format excel dapat didownload <a href="<?php echo base_url().'media/download/format_upload_data_rekam_jejak_alumni.xls'?>" class="btn btn-sm btn-success" style="color:#fff">disini</a>
	<br><br>
