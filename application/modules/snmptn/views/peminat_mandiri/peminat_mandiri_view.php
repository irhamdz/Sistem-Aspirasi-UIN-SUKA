<h2>Daftar Nilai Peminat Mandiri</h2>
...
<a href="<?php echo site_url('snmptn/peminat_mandiri/impor')?>" id="add" class="btn btn-inverse btn-small aksi" style="color:#fff" ><i class="icon-edit icon-white">&nbsp;</i> Impor Excel</a>
</div>
...
<table class="table table-bordered">
  ...
  <tbody>
      <?php if(!isset($peminat_mandiri) or empty($peminat_mandiri)):
      	echo '<td colspan="6" align="center">Belum ada data.</td>';
      else:
			$i = $offset;
		  foreach ($peminat_mandiri as $d): 
			$i++;
			?>
			<tr>
