...
<div id="information" class="bs-callout bs-callout-success">
	Format excel dapat didownload <a href="<?php echo base_url().'media/download/format_upload_data_riwayat_sbmptn.xls'?>" class="btn btn-sm btn-success" style="color:#fff">disini</a>
	<br><br>
