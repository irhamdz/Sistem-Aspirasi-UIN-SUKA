<h2 style="margin-bottom:30px;">Impor Data Pilihan</h2>
...
<div id="information" class="bs-callout bs-callout-success">
	...
	<ol>
		...
		<li>Urutan PTN</li>
		<li>Urutan Program Studi</li>
		<li>Kode Program Studi</li>
		<li>Program Studi</li>
		<li>Diterima PTN Lain (0 jika belum diterima PTN lain, 1 jika belum diterima PTN lain)</li>
	</ol>
</div>
<script>
	$(function(){
