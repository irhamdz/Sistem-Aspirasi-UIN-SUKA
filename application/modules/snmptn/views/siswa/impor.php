...
<div id="information" class="bs-callout bs-callout-success">
	Format excel dapat didownload <a href="<?php echo base_url().'media/download/format_upload_data_siswa.xls'?>" class="btn btn-sm btn-success" style="color:#fff">disini</a>
	<br><br>
	...
	<ol>
		...
		<li>Tahun UN</li>
		<li>Bidik Misi</li>
		<li>KAP Bidik Misi</li>
		<li>Nilai di bawah KKM </li>
		<li>Jenis Kelas </li>
	</ol>
</div>
<script>
