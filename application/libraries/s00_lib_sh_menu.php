...
class S00_lib_sh_menu {
	...
	public function get_url_var(){	
		return array(				'vmk1' 	=> 'krsnormal-hapus#_0295_krs_hapus',
									...
									'vmd1'	=> 'mahasiswa-sessionid#_0200_sessionid',
									...
									'vdw2' 	=> 'kepenasihatan-krsanulir#_0395_perwalian_larang_batal',
									'vdw3' 	=> 'kepenasihatan-krshapus#_0395_perwalian_hapus_tambah',
									...
									'vdd1'	=> 'dosen-sessionid#_0300_sessionid',
	...
	public function get_mnu_stt(){	
		return array( 				'mmi3'	=> 'Input KRS Semester Pendek',
